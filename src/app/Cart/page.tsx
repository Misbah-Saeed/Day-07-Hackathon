...
const CartPage = () => {
  const [cart, setCart] = useState<CartItem[]>([]);  // ✅ Specify type for useState
  ...
  return (
    <>
      ...
      <div className="mb-3 mt-10 flex justify-evenly items-center p-2 w-[100%] h-[200px] bg-[#F9F1E7]">
        <div>
          <Image src="/images/Vector.png" width={40} height={40} alt="High Quality" />
          <h4 className="font-bold">High Quality</h4>
          <p>crafted from top materials</p>
        </div>
        <div>
          <Image src="/images/Vector (1).png" width={40} height={40} alt="Warranty" />
          <h4 className="font-bold">Warranty Protection</h4>
          <p>Over 2 years</p>
        </div>
        <div>
          <Image src="/images/Vector (2).png" width={40} height={40} alt="Shipping" />
          <h4 className="font-bold">Free Shipping</h4>
          <p>Order over $150</p>
        </div>
        <div>
          <Image src="/images/Vector (3).png" width={40} height={40} alt="Support" />
