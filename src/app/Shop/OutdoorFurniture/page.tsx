...
export default async function OutdoorFurniture() {
  // ✅ Fetch products with `defined(slug.current)` to prevent errors
  const products: Product[] = await client.fetch(
    `*[_type == "product" && category == "outdoor & tropical furniture" && defined(slug.current)]{
      title,
      price,
      description,
      productImage {
